...
df = pd.read_csv(os.path.join("uncompressed", "2008_14col.data"), header=None, names=columns)
...
tx.plot(np.arange(temp.shape[0]), temp["violation"].values, color="C3", label="Violation")
